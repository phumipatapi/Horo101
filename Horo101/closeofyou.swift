...
//  Horo101
//
//  Created by Phumipat Apivansri on 28/11/2563 BE.
//

import UIKit

class closeofyou: UIViewController {
    var tarot = [tarotcard]()
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        menulb.adjustsFontSizeToFitWidth = true
        ...
        cardbtn7.imageView?.contentMode = .scaleAspectFit
        cardbtn7.layer.shadowColor = UIColor.red.cgColor
        cardbtn7.layer.shadowOffset = CGSize(width: 0, height: 0.3)
        cardbtn7.layer.shadowRadius = 25
        cardbtn7.layer.shadowOpacity = 0.2
        cardbtn7.layer.masksToBounds = false
    ...
    @IBAction func nextpic(_ sender: Any) {
        ...
        if cardshow.image == img[0] {
            ...
            cardshow.image = img[6]
            cardname.text = name[6]
            cardmean.text = means[6]
            descript.text = scene[6]
            previousbtn.isHidden = false
    ...
    var means = [String]()
    var name = [String]()
    var scene = ["ความต้องการของคุณ","ความต้องการของอีกฝ่าย","ความแตกต่างของคุณกับเขา","ความเหมือนของคุณกับเขา","คุณรู้สึกอย่างไรกับเขา","ภาพลักษณ์ภายนอก","จิตใจของทั้งคู่"]
    var isOpen = false
    var isOpen2 = false
    var isOpen3 = false
    var isOpen4 = false
    ...
    func random() {
        ...
        img.append(contentsOf: [imgshow1!,imgshow2!,imgshow3!,imgshow4!,imgshow5!,imgshow6!,imgshow7!])
        means.append(contentsOf: [cardmean1,cardmean2,cardmean3,cardmean4,cardmean5,cardmean6,cardmean7])
        name.append(contentsOf: [cardname1,cardname2,cardname3,cardname4,cardname5,cardname6,cardname7])
        ...
        cardbtn7.setImage(imgshow7, for: .normal)
    }
    func transition() {
        ...
        UIView.transition(with: cardbtn7, duration: 2.1, options: .transitionFlipFromRight, animations: nil, completion: nil)
