...
class problem: UIViewController {
    ...
    var means = [String]()
    var name = [String]()
    var scene = ["เป้าหมายที่ต้องการ","อุปสรรคที่ขัดขวาง","สิ่งที่ฉุดรั้งคุณไว้","สิ่งที่ผลักดันคุณไปข้างหน้า","สิ่งที่มุ่งหวังจะได้จากการทำงาน","ต้นตอปัญหา"]
    var isOpen = false
    var isOpen2 = false
    var isOpen3 = false
    var isOpen4 = false
    ...
    func random() {
        ...
        cardbtn2.setImage(imgshow2rot, for: .normal)
