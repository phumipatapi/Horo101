...
class readytolove: UIViewController {
var tarot = [tarotcard]()
    ...
    var means = [String]()
    var name = [String]()
    var scene = ["ความรักในอุดมคติ","บทเรียนจากความรัก","สิ่งที่ควรสำเร็จก่อนมีความรัก","คุณคิดถึงใครในใจ","คุณพร้อมเปิดรับใครเข้ามาไหม","ทัศนคติต่อความรัก"]
    var isOpen = false
    var isOpen2 = false
    var isOpen3 = false
    var isOpen4 = false
